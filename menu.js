...
menu1.url = "?menu=1"
menu1.tips = ["2.1 공통모듈구현","2.2 테스트케이스 작성","2.3 단위테스트","2.4 테스트결과 보고서"] //로그인 로그아웃 기능
menu2 = new Menu("3. 서버프로그램 구현")
menu2.url = "?menu=2"
menu2.tips = ["3.1 회원가입 구현","3.2 회원 로그인 구현","3.3 회원 로그아웃 구현","3.4 회원 리스트 출력 구현 ","3.5 테스트케이스","3.6 Mock Object 테스트","3.7 "]
